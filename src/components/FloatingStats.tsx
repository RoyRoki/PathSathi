...
export function FloatingStats({
    ...
    return (
        <div
            ref={statsRef}
            className="absolute bottom-0 left-1/2 -translate-x-1/2 -translate-y-[20%] z-30 w-full max-w-5xl px-6"
        >
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {stats.map((stat, index) => (
                    <div
                        key={index}
                        className="stat-card floating-stat-card group relative overflow-hidden rounded-2xl bg-black/20 backdrop-blur-2xl border border-white/10 shadow-2xl p-6 hover:shadow-3xl hover:border-white/20 hover:bg-black/30 transition-all duration-500"
                    >
                        {/* Gradient background */}
                        <div
                        ...
                        <div className="relative z-10">
                            {/* Icon */}
                            <div
                                className={`flex h-12 w-12 items-center justify-center rounded-xl text-white bg-white/10 mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-lg backdrop-blur-sm`}
                            >
                            ...
                            <div className="mb-1">
                                ...
                                <span className="text-lg text-white/80 ml-1 font-light">{stat.unit}</span>
                            </div>
