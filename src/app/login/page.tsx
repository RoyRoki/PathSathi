...
export default function LoginPage() {
  ...
  return (
    <main ref={containerRef} className="relative min-h-screen flex flex-col bg-background">
      <div className="flex-1 flex overflow-hidden">
        {/* Left side: Premium Image */}
        <section className="hidden lg:flex relative w-1/2 overflow-hidden min-h-[calc(100vh-100px)]">
          <Image
      ...
      {/* Full width footer */}
      <div className="w-full py-8 text-center bg-background border-t border-border/40">
        <h3 className="font-display text-xl text-primary mb-2">Crafted in Siliguri. Built for the Mountains.</h3>
